...
import {
  generateKPIs, generateAlerts, generateTimeSeriesData,
  generateOccupancy, generateStadiumHeatmap
} from '../data/mockData';
...
export default function Dashboard() {
  ...
  const [occupancy] = useState(generateOccupancy());
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setTimeData(generateTimeSeriesData());
